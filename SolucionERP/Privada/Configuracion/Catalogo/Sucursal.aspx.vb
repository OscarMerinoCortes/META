...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            End If
            '======================================================================PARTE DE SEGURIDAD
            ''''''Tarjeta.IdOpcion = Operacion.Configuracion.Constante.Opcion.Sucursal
            ...
            ''''''    'SeguridadTransaccion
            ''''''    Tarjeta.IdTransaccion = Operacion.Configuracion.Constante.Transaccion.Consultar
            ''''''    IBTConsultar.Enabled = Seguridad.Autorizacion.Transaccion.Validar(Tarjeta)
            '=========================================================================================================================
