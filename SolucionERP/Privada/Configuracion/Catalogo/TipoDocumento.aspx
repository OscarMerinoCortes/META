<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="TipoDocumento.aspx.vb" Inherits="_Default" %>
        ...
        <asp:View ID="VConsulta" runat="server">
            <table style="width: 100%;">
                <tr style="text-align: center;">
                    <td style="width: 100%;">
                        <asp:GridView ID="GVTipoDocumento" Width="100%" runat="server"
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="SegundaColumna">
                        <asp:TextBox ID="TBIdTipoDocumento" runat="server" Enabled="False" Width="150"></asp:TextBox>
                    </td>
                </tr>
