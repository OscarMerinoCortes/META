<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="TipoEmpleo.aspx.vb" Inherits="_Default" %>
        ...
        <asp:View ID="VConsulta" runat="server">
            <table style="width: 100%;">
                <tr style="text-align: center;">
                    <td style="width: 100%;">
                        <asp:GridView ID="GVTipoEmpleo" Width="100%" runat="server"
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td class="SegundaColumna">
                        <asp:TextBox ID="TBIdTipoEmpleo" runat="server" Enabled="False" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Empleo" />
                    </td>
                    <td>
