<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="TipoEstadoCivil.aspx.vb" Inherits="_Default" %>
        ...
        <asp:View ID="VConsulta" runat="server">
            <table style="width: 100%;">
                <tr style="text-align: center;">
                    <td style="width: 100%;">
                        <asp:GridView ID="GVTipoEstadoCivil" Width="100%" runat="server"
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td class="SegundaColumna">
                        <asp:TextBox ID="TBIdTipoEstadoCivil" runat="server" Enabled="False" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td>
                        <asp:TextBox ID="TBDescripcion" runat="server" Width="150px" />
                         <asp:RequiredFieldValidator ID="RFVDescripcion" runat="server" ControlToValidate="TBDescripcion"
                                                            ErrorMessage="&lt;strong>Información requerida</strong> El Estado Civil es Obligatorio"
                        ...
                        <asp:ValidatorCalloutExtender ID="VCEDescripcion" runat="server" TargetControlID="RFVDescripcion"></asp:ValidatorCalloutExtender>
                            <asp:RegularExpressionValidator Display="none" ID="REVDescripcion" runat="server" ErrorMessage="Este Campo Solo Admite Letras" ValidationExpression="^[A-Z a-z]*$" ValidationGroup="Guardar" ControlToValidate="TBDescripcion"></asp:RegularExpressionValidator>
                      <asp:ValidatorCalloutExtender ID="VCEERDescripcion" runat="server" TargetControlID="REVDescripcion"> </asp:ValidatorCalloutExtender>
                    </td>
                </tr>
                <tr>
                    <td></td>
