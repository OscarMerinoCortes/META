...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            CType(Master.FindControl("LBOpcion"), Label).Text = "Reporte de Cuenta por pagar"
            LlenarDDs()
    ...
    Private Sub LlenarSolicitudes()
        ...
        LBCantidadBusqueda.Text = "Cuentas por pagar: " + TablaCompra.Rows.Count.ToString()
        LBCantidadBusqueda.Text = "Cuentas por pagar: " + (TablaCompra.Rows.Count).ToString()
    End Sub
    ...
    Private Sub Imprimir()
        ...
        objTextFile = objFSO.OpenTextFile(Server.MapPath("~") + "Imprimir\Formatos\CXP\Reportes\ReporteCuentaPorPagar.html", ForReading)
