<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="ReporteCompra.aspx.vb" Inherits="_Default" %>
                ...
                <div class="row" runat="server" id="divAvanzado" style="padding-right: 20px;">
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4" style="padding-right: 0;">
                        <div class="input-group">
                            <label class="input-group-addon" style="padding: 0px;" >Compra</label>
                            <asp:TextBox ID="TBCompra" runat="server"  AutoPostBack="True" CssClass="form-control" Style="text-align: right;" />
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4" style="padding: 0;">
                        <div class="input-group">
                            <span class="input-group-addon" style="padding-right: 5px; text-align: right;">Clasificacion</span>
                            <asp:DropDownList ID="DDClasificacion" runat="server" AutoPostBack="True" CssClass="form-control" Style="direction: rtl;" />
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4" style="padding: 0;">
                        <div class="input-group">
                            <span class="input-group-addon" style="padding-right: 5px; text-align: right;">Subclasificacion</span>
