<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="ReporteOrdenCompra.aspx.vb" Inherits="_Default" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row" runat="server" id="divAvanzado" style="padding-right: 20px;">
                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4" style="padding-right: 0;">
                        <div class="input-group">
                            <label class="input-group-addon" style="padding: 0px;">Orden</label>
                            <asp:TextBox ID="TBOrden" runat="server" AutoPostBack="True"  CssClass="form-control" Style="text-align: right;" />
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top: 0px; padding-left: 0px; padding-right: 0px;">
                    <div id="divconsulta" class="panel-body col-xs-12" style="overflow: auto; padding: 0; font-size: medium; text-align: center;">
                        <asp:GridView ID="GVOrden" Style="margin: 0 auto;" runat="server" AutoGenerateColumns="false"
