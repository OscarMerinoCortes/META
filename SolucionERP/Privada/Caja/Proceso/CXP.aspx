<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="CXP.aspx.vb" Inherits="_Default" %>
...
<%@ Register Src="~/Wuc/WucBusquedaProveedor.ascx" TagName="wucConsultarProveedor" TagPrefix="WUCProv" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="5"><WUCDA:wucDatosAuditoria ID="wucDatosAuditoria1" Visible="false" runat="server" style="width: 100%;" />
                    </td>
                </tr>
                <tr>
                    <td colspan="5">
                ...
                <tr style="text-align: center;">
                    <td colspan="5">
                        <asp:GridView ID="GVCCP" runat="server" AllowPaging="false" CaptionAlign="Top" AlternatingRowStyle-CssClass="alt" CssClass="GridComun" Width="100%" PagerStyle-CssClass="pgr" GridLines="None" HorizontalAlign="Center" Style="margin: 0 auto;">
                            ...
                            <Columns>
                                <asp:TemplateField><ItemTemplate><asp:LinkButton ID="BTNSeleccionar" runat="server" AutoPostBack="true"
                                            ForeColor="Blue" Text="Seleccionar" ShowSelectButton = "True" OnClick="BTNSeleccionar_OnClick"/></ItemTemplate></asp:TemplateField>
                                ...
                                <asp:TemplateField><HeaderTemplate>Descripcion</HeaderTemplate><ItemTemplate><%# Comun.Presentacion.StringTruncado.Truncar(Eval("Descripcion"), 50)%>...</ItemTemplate></asp:TemplateField>
                                <asp:TemplateField><HeaderTemplate>Abonar</HeaderTemplate><ItemTemplate><asp:TextBox ID="TBGVAbono" AutoPostBack="true" runat="server" OnTextChanged="TBGVAbono_TextChanged" /></ItemTemplate></asp:TemplateField>
                                <asp:TemplateField><HeaderTemplate><asp:CheckBox ID="CBGVAbonoHeader" runat="server" AutoPostBack="true" Checked="false" OnCheckedChanged="CBGVAbonoHeader_CheckedChanged" />Abonar</HeaderTemplate><ItemTemplate><asp:CheckBox ID="CBGVAbonoItem" runat="server" AutoPostBack="true" Checked="false" OnCheckedChanged="CBGVAbonoItem_CheckedChanged" /></ItemTemplate></asp:TemplateField>
                                <asp:TemplateField><HeaderTemplate>Concepto</HeaderTemplate><ItemTemplate><asp:TextBox ID="TBGVConcepto" runat="server"/></ItemTemplate></asp:TemplateField>
...
<%--                                <asp:TemplateField><HeaderTemplate><asp:CheckBox ID="CBGVLiquidacionHeader" runat="server" AutoPostBack="true" Checked="false" OnCheckedChanged="CBGVLiquidacionHeader_CheckedChanged" />Liquidar</HeaderTemplate><ItemTemplate><asp:CheckBox ID="CBGVLiquidacionItem" runat="server" AutoPostBack="true" Checked="false" OnCheckedChanged="CBGVLiquidacionItem_CheckedChanged" /></ItemTemplate></asp:TemplateField>
...
<%--                                <asp:BoundField DataField="Sucursal" HeaderText="Sucursal" SortExpression="Sucursal" Visible="true" />--%>
        ...
        <asp:View ID="View3" runat="server">
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="4">
                        <ajaxToolkit:Accordion ID="Accordion1" runat="server" ContentCssClass="accordionContent" CssClass="accordion" HeaderCssClass="accordionHeader" HeaderSelectedCssClass="accordionHeaderSelected" Height="2500px" Width="100%"><Panes><ajaxToolkit:AccordionPane ID="AccordionPane0" runat="server" ContentCssClass="" HeaderCssClass="" Visible="True"><Header>&#160;&#160;&#160;&#160;&#160;&#160;&#160;Venta</Header><Content><table style="width: 100%; text-align: center;"><tr><td><asp:GridView ID="GVCajaVentaDetalle" Style="margin: 0 auto;" runat="server" AllowPaging="false" AlternatingRowStyle-CssClass="alt" CssClass="GridComun" PagerStyle-CssClass="pgr" GridLines="None" CaptionAlign="Top" HorizontalAlign="Center"></asp:GridView></td></tr><tr></tr><tr style="text-align: center;"><td></td></tr></table></Content></ajaxToolkit:AccordionPane><ajaxToolkit:AccordionPane ID="AccordionPane1" runat="server" ContentCssClass="" HeaderCssClass="" Visible="True"><Header>&#160;&#160;&#160;&#160;&#160;&#160;&#160;Historial</Header><Content><table style="width: 100%; text-align: center;"><tr><td><asp:GridView ID="GVCajaHistorial" Style="margin: 0 auto;" runat="server" AllowPaging="false" AlternatingRowStyle-CssClass="alt" CssClass="GridComun" PagerStyle-CssClass="pgr" GridLines="None" CaptionAlign="Top" HorizontalAlign="Center"></asp:GridView></td></tr></table></Content></ajaxToolkit:AccordionPane><ajaxToolkit:AccordionPane ID="AccordionPane2" runat="server" ContentCssClass="" HeaderCssClass="" Visible="True"><Header>&#160;&#160;&#160;&#160;&#160;&#160;&#160;Proyeccion de Liquidacion</Header><Content><table><tr><td><asp:TextBox ID="TBFechaLiquidacion" runat="server" AutoPostBack="true"></asp:TextBox><ajaxToolkit:CalendarExtender ID="CalendarExtender2" Enabled="True" runat="server" Format="dd/MM/yyyy" PopupPosition="BottomRight" TargetControlID="TBFechaLiquidacion" /></td><td><asp:Label ID="LBCondonacion" runat="server" Text="Condonacion si Liquida:"></asp:Label></td></tr><tr><td></td><td><asp:Label ID="LBLiquidacion" runat="server" Text="Monto de Liquidacion:"></asp:Label></td></tr></table></Content></ajaxToolkit:AccordionPane></Panes></ajaxToolkit:Accordion>
