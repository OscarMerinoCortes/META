<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="TipoDescuento.aspx.vb" Inherits="_Default" %>
        ...
        <asp:View ID="VConsulta" runat="server">
            <table style="width: 100%;">
                <tr style="text-align: center;">
                    <td style="width: 100%;">
                        <asp:GridView ID="GVTipoDescuento" Width="100%" runat="server"
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="SegundaColumna">
                        <asp:TextBox ID="TBIdTipoDescuento" runat="server" Enabled="False" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Descuento" />
                    </td>
                    <td>
