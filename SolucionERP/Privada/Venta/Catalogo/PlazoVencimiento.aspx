<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="PlazoVencimiento.aspx.vb" Inherits="_Default" %>
        ...
        <asp:View ID="VConsulta" runat="server">
            <table style="width: 100%;">
                <tr style="text-align: center;">
                    <td style="width: 100%;">
                        <asp:GridView ID="GVPlazoVencimiento" Width="100%" runat="server"
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td class="SegundaColumna">
                        <asp:TextBox ID="TBIdPlazoVencimiento" runat="server" Enabled="False" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td class="PrimeraColumna">Maximo</td>
                    <td class="SegundaColumna">
                        <asp:TextBox ID="TBMaximo" runat="server" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td>Minimo</td>
                    <td>
                        <asp:TextBox ID="TBMinimo" runat="server" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
