<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" CodeFile="TipoVenta.aspx.vb" Inherits="_Default" %>
        ...
        <asp:View ID="VConsulta" runat="server">
            <table style="width: 100%;">
                <tr style="text-align: center;">
                    <td style="width: 100%;">
                        <asp:GridView ID="GVTipoVenta" Width="100%" runat="server"
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td class="SegundaColumna">
                        <asp:TextBox ID="TBIdTipoVenta" runat="server" Enabled="False" Width="150px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Venta" />
                    </td>
                    <td>
