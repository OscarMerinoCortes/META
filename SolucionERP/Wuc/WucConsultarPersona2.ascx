<%@ Control Language="vb" AutoEventWireup="false" CodeFile="WucConsultarPersona2.ascx.vb" Inherits="WucConsultarPersona2" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>      
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                <td class="PrimeraColumna">Equivalencia</td>
            ...
            <tr>
                <td>Nombre</td>
                <td>
                    <asp:TextBox ID="TBNombre" runat="server" Enabled="False" AutoPostBack="True" Width="300" />
                </td>
            </tr>
        </table>
    </ContentTemplate>
