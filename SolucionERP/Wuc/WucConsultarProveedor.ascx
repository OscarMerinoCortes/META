<%@ Control Language="vb" AutoEventWireup="false" CodeFile="WucConsultarProveedor.ascx.vb" Inherits="WucConsultarProveedor" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>      
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td class="PrimeraColumna">ID Proveedor</td>
