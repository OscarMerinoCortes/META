...
Public Class WucGraficaCXC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Chart6.ChartAreas(0).AxisX.IntervalType = DataVisualization.Charting.DateTimeIntervalType.Number
        Chart6.ChartAreas(0).AxisX.IntervalAutoMode = DataVisualization.Charting.IntervalAutoMode.VariableCount
        Chart6.Legends(0).Enabled = True

        Chart7.Legends(0).Enabled = True
        'Chart1.ChartAreas(0).AxisX.IsInterlaced = True
        Chart7.ChartAreas(0).AxisX.IntervalType = DataVisualization.Charting.DateTimeIntervalType.Number
        Chart7.ChartAreas(0).AxisX.IntervalAutoMode = DataVisualization.Charting.IntervalAutoMode.VariableCount
        Chart7.Legends(0).Enabled = True
