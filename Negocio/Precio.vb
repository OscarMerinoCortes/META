Public Class Precio
    ...
    Public Sub Consultar(ByRef EntidadPrecio As Entidad.EntidadBase) Implements ICatalogo.Consultar
        'Dim DatosTipoDomicilio As New Datos.Rutas()
        'DatosTipoDomicilio.Consultar(EntidadRuta)

    End Sub

    Public Overridable Sub Guardar(ByRef EntidadPrecio As Entidad.EntidadBase) Implements ICatalogo.Guardar
        ...
        'End If
    End Sub
    Public Sub Obtener(ByRef EntidadPrecio As Entidad.EntidadBase) Implements ICatalogo.Obtener
        Dim DatosProducto As New Datos.Precio()
        DatosProducto.Obtener(EntidadPrecio)
    End Sub
End Class
